  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="flex justify-end mb-6">
        <SavePageButton targetId="match-prediction-capture-area" fileName="my-group-stage-predictions.png" />
      </div>

      <div id="match-prediction-capture-area" className="bg-[#111827] p-2 sm:p-6 rounded-2xl">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl p-6 mb-10 shadow-lg max-w-4xl mx-auto">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-300 ml-2">
            ...
            <li>You can submit responses any number of times but new response will overwrite old response</li>
          </ul>
        </div>
